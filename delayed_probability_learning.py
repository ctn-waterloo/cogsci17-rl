...
# This version the prediction is one time period behind realtime
# It can't be used online, but can still be used for overall analysis
...
with model:
    ...
    conn = nengo.Connection(model.state_and_action, model.probability.input,
                            ...
                            learning_rule_type=nengo.PES(pre_tau=0.005),
                           )
